		...
		<React.Fragment>
			<div className={style.sidebar}>
				...
				<div className={style.sidebar__features}>
					...
					<li
						className={
							activePage === 'truckRequest'
								? style.sidebar__featuresActive
								: style.sidebar__featureslink
						} 
            onClick={() => {
              dispatch(DashboardRender('truckRequest'))
            }}
            >
						<IoMdWallet size='1.25rem' className={style.icon} />{' '}
						<p>Truck Request</p>
					</li>
					<li
						className={
						...
						onClick={() => {
							dispatch(DashboardRender('trackOrder'));
						}}>
						{' '}
						<HiCube size='1.25rem' className={style.icon} /> <p>Track Orders</p>
					</li>
					<li
						className={
