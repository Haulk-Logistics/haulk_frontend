  ...
  return (
    <div className={styles.footer}>
      ...
      <div className={`${styles["footer-bottom"]}`}>
        <p>
          Haulk Logistics is a company that aims to facilitate the stress-free,
          careful and speedy movement of goods from one point to another within
          Nigeria.
        </p>
        <p>Copyright © 2022 Haulk Logistics. All rights reserved</p>
      </div>
    </div>
  );
};
